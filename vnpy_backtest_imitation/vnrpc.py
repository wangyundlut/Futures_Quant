...
class RpcServer(RpcObject):
    ...
    def publish(self, topic, data):
        ...
        # 通过广播socket发送数据
        self.__socketPUB.send_multipart([binascii.b2a_hex(topic.encode('utf-8')), datab])
...
class RpcClient(RpcObject):
    ...
    def subscribeTopic(self, topic):
        ...
        注意topic必须是ascii编码
        """
        self.__socketSUB.setsockopt(zmq.SUBSCRIBE, binascii.b2a_hex(topic.encode('utf-8')))
